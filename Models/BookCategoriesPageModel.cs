...
namespace Muresan_Miriam_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Muresan_Miriam_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Muresan_Miriam_Lab8Context context,
